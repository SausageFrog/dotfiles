...
keys.globalkeys = gears.table.join(
    ...
    -- Close Windows 
  --  awful.key({ modkey,           }, "q", function () awful.client.focus:kill() end,
  --            {description = "close windows", group = "client"}),
    ...
    awful.key({}, "XF86AudioRaiseVolume", function()
      awful.spawn.easy_async_with_shell("pactl set-sink-volume @DEFAULT_SINK@ +3%",
        function() awesome.emit_signal("popup::volume", {amount = 3})
          end)
        end, 
    {description = "raise volume by 3%", group = "audio" }),
    --
    ...
    {description = "lower volume by 3%", group = "audio"}),
    --
    awful.key({}, "XF86AudioMute", function()
      awful.spawn.easy_async_with_shell("pactl set-sink-mute @DEFAULT_SINK@ toggle",
        function() awesome.emit_signal("popup::volume") end)
          end, 
